...
call 03_Sub.Create_Factors_For_Spat_Interp_Lay%3_K.bat   %1    ..\Lay_%3_K_PP_List.txt    ..\Lay_%3_Zone_Arr.txt       Struct_File.%2.Variogram.txt   ..\Carmel-Interpolated_%2_By_ppk2fac.txt      %2       400000.0
