...
# 7 gages
H1 <- read.table('H1.gg1', skip=2, header=FALSE, col.names=c('Time','Stage','Flow','Depth','Width','MidptFlow','Precip','ET','SFRRunoff','UZFRunoff','Conductance','Headdif','Grad'))
NC <- read.table('NC.gg3', skip=2, header=FALSE, col.names=c('Time','Stage','Flow','Depth','Width','MidptFlow','Precip','ET','SFRRunoff','UZFRunoff','Conductance','Headdif','Grad'))
GA <- read.table('GA.gg7', skip=2, header=FALSE, col.names=c('Time','Stage','Flow','Depth','Width','MidptFlow','Precip','ET','SFRRunoff','UZFRunoff','Conductance','Headdif','Grad'))
DJ <- read.table('DJ.gg8', skip=2, header=FALSE, col.names=c('Time','Stage','Flow','Depth','Width','MidptFlow','Precip','ET','SFRRunoff','UZFRunoff','Conductance','Headdif','Grad'))
RR <- read.table('RR.gg10', skip=2, header=FALSE, col.names=c('Time','Stage','Flow','Depth','Width','MidptFlow','Precip','ET','SFRRunoff','UZFRunoff','Conductance','Headdif','Grad'))
SH <- read.table('SH.gg12', skip=2, header=FALSE, col.names=c('Time','Stage','Flow','Depth','Width','MidptFlow','Precip','ET','SFRRunoff','UZFRunoff','Conductance','Headdif','Grad'))
CL <- read.table('CL.gg13', skip=2, header=FALSE, col.names=c('Time','Stage','Flow','Depth','Width','MidptFlow','Precip','ET','SFRRunoff','UZFRunoff','Conductance','Headdif','Grad'))
# 
H1
...
H1_dates_full <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
NC_dates_full <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
GA_dates_full <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
DJ_dates_full <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
RR_dates_full <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
SH_dates_full <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
CL_dates_full <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')

H1_dates_calib <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
NC_dates_calib <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
GA_dates_calib <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
DJ_dates_calib <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
RR_dates_calib <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
SH_dates_calib <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
CL_dates_calib <- seq(as.Date('1991-10-01'), as.Date('2015-09-30'), by='day')
...
H1_df <- data.frame(wyr = 1991:2015)
...
NC_df <- data.frame(wyr = 1991:2015)
...
GA_df <- data.frame(wyr = 1991:2015)
...
DJ_df <- data.frame(wyr = 1991:2015)
...
RR_df <- data.frame(wyr = 1991:2015)
...
SH_df <- data.frame(wyr = 1991:2015)
...
CL_df <- data.frame(wyr = 1991:2015)
...
png('H1_WY_totals.png',width=6.5, height=4.5, units='in',res=140)
  ...
  axis(side=1, at=seq(2,74,by=3), labels=H1_df$wyr, las=2)
...
png('NC_WY_totals.png',width=6.5, height=4.5, units='in',res=140)
  ...
  abline(h=0)
  axis(side=2, at=seq(0,300000,50000), labels=c('0','50,000','100,000','150,000','200,000','250,000','300,000'), las=1)
  axis(side=1, at=seq(2,74,by=3), labels=NC_df$wyr, las=2)
  mtext(side=2, expression(paste('Total WY Discharge, ',ac%.%ft,sep='')), line=4.5)
  legend('topright', c('Simulated','Observed'),pch=22,pt.bg=c('grey40','grey90'),pt.cex=1.5,bty='n',bg='white')
dev.off()
...
png('GA_WY_totals.png',width=6.5, height=4.5, units='in',res=140)
  ...
  axis(side=1, at=seq(2,74,by=3), labels=GA_df$wyr, las=2)
  mtext(side=2, expression(paste('Total WY Discharge, ',ac%.%ft,sep='')), line=4.5)
  legend('topright', c('Simulated','Observed'),pch=22,pt.bg=c('grey40','grey90'),pt.cex=1.5,bty='n',bg='white')
dev.off()
...
png('DJ_WY_totals.png',width=6.5, height=4.5, units='in',res=140)
  ...
  abline(h=0)
  axis(side=2, at=seq(0,300000,50000), labels=c('0','50,000','100,000','150,000','200,000','250,000','300,000'), las=1)
  axis(side=1, at=seq(2,74,by=3), labels=DJ_df$wyr, las=2)
  mtext(side=2, expression(paste('Total WY Discharge, ',ac%.%ft,sep='')), line=4.5)
  legend('topright', c('Simulated','Observed'),pch=22,pt.bg=c('grey40','grey90'),pt.cex=1.5,bty='n',bg='white')
dev.off()
...
png('RR_WY_totals.png',width=6.5, height=4.5, units='in',res=140)
  ...
  abline(h=0)
  axis(side=2, at=seq(0,300000,50000), labels=c('0','50,000','100,000','150,000','200,000','250,000','300,000'), las=1)
  axis(side=1, at=seq(2,74,by=3), labels=RR_df$wyr, las=2)
  mtext(side=2, expression(paste('Total WY Discharge, ',ac%.%ft,sep='')), line=4.5)
  legend('topright', c('Simulated','Observed'),pch=22,pt.bg=c('grey40','grey90'),pt.cex=1.5,bty='n',bg='white')
dev.off()
...
png('SH_WY_totals.png',width=6.5, height=4.5, units='in',res=140)
  ...
  axis(side=1, at=seq(2,74,by=3), labels=SH_df$wyr, las=2)
  mtext(side=2, expression(paste('Total WY Discharge, ',ac%.%ft,sep='')), line=4.5)
  legend('topright', c('Simulated','Observed'),pch=22,pt.bg=c('grey40','grey90'),pt.cex=1.5,bty='n',bg='white')
dev.off()
...
png('CL_WY_totals.png',width=6.5, height=4.5, units='in',res=140)
  ...
  abline(h=0)
  axis(side=2, at=seq(0,50000,10000), labels=c('0','10,000','20,000','30,000','40,000','50,000'), las=1)
  axis(side=1, at=seq(2,74,by=3), labels=CL_df$wyr, las=2)
  mtext(side=2, expression(paste('Total WY Discharge, ',ac%.%ft,sep='')), line=4.5)
  legend('topright', c('Simulated','Observed'),pch=22,pt.bg=c('grey40','grey90'),pt.cex=1.5,bty='n',bg='white')
dev.off()
