...
echo %1      > Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Enter name of pilot points file:
echo %2     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Enter minimum allowable points separation:
echo 0.0    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Enter name of zonal integer array file:
echo %3     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Is this a formatted or unformatted file? [f/u]:
echo f      >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Enter name of structure file:
echo %4     >> Auto_Set_Paramater_Values_For_ppk2fac.txt

REM     For zone characterised by integer value of 0:-
REM     Enter structure name (blank if no interpolation for this zone):
echo %6     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Perform simple or ordinary kriging [s/o]:
echo o    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Enter search radius:
echo %7   >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
echo 8    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
REM     For zone characterised by integer value of 4:-
REM     Enter structure name (blank if no interpolation for this zone):
echo %6     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Perform simple or ordinary kriging [s/o]:
echo o    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
REM     For zone characterised by integer value of 5:-
REM     Enter structure name (blank if no interpolation for this zone):
echo %6     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Perform simple or ordinary kriging [s/o]:
echo o    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
REM     For zone characterised by integer value of 6:-
REM     Enter structure name (blank if no interpolation for this zone):
echo %6     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Perform simple or ordinary kriging [s/o]:
echo o    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
REM     For zone characterised by integer value of 7:-
REM     Enter structure name (blank if no interpolation for this zone):
echo %6     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Perform simple or ordinary kriging [s/o]:
echo o    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
REM     For zone characterised by integer value of 8:-
REM     Enter structure name (blank if no interpolation for this zone):
echo %6     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Perform simple or ordinary kriging [s/o]:
echo o    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
REM     For zone characterised by integer value of 9:-
REM     Enter structure name (blank if no interpolation for this zone):
echo %6     >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM     Perform simple or ordinary kriging [s/o]:
echo o    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
...
echo %5    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Is this a formatted or unformatted file? [f/u]:
echo f    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Enter name for output standard deviation array file:
echo t.OUTPUT_sd.ref.txt    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Is this a formatted or unformatted file? [f/u]:
echo f    >> Auto_Set_Paramater_Values_For_ppk2fac.txt
REM  Enter name for regularisation information file:
echo t.OUTPUT_reg.txt   >> Auto_Set_Paramater_Values_For_ppk2fac.txt

ppk2fac.exe  < Auto_Set_Paramater_Values_For_ppk2fac.txt  >>  s.report.txt
